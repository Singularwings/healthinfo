...
module.exports = "<!--The content below is only a placeholder and can be replaced.-->\r\n<mat-sidenav-container class=\"container\">\r\n  <mat-sidenav mode=\"side\" opened >\r\n    <mat-nav-list role=\"list\">\r\n      <mat-list-item role=\"listitem\">Item 001</mat-list-item>\r\n      <mat-list-item role=\"listitem\">Item 002</mat-list-item>\r\n      <mat-list-item role=\"listitem\">Item 003</mat-list-item>\r\n      <mat-list-item role=\"listitem\">Item 004</mat-list-item>\r\n      <mat-list-item role=\"listitem\">Item 005</mat-list-item>\r\n      <mat-list-item role=\"listitem\">Item 006</mat-list-item>\r\n      <mat-list-item role=\"listitem\">Item 007</mat-list-item>\r\n      <mat-list-item role=\"listitem\">Item 008</mat-list-item>\r\n      <mat-list-item role=\"listitem\">Item 009</mat-list-item>\r\n      <mat-list-item role=\"listitem\">Item 010</mat-list-item>\r\n      <mat-list-item role=\"listitem\">Item 011</mat-list-item>\r\n    </mat-nav-list>\r\n  </mat-sidenav>\r\n  <mat-sidenav-content >\r\n    <chart [options]=\"options\" type=\"StockChart\" (load)=\"onLoad($event)\"></chart>\r\n  </mat-sidenav-content>\r\n  <router-outlet></router-outlet>\r\n</mat-sidenav-container>\r\n"
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.onLoad = function (event) {
        ...
        var series = event.context.series[0];
        var timer = __WEBPACK_IMPORTED_MODULE_1_rxjs_observable_TimerObservable__["a" /* TimerObservable */].create(0, 1000);
        timer.subscribe(function (x) {
            var y = 0;
            var random = Math.random();
            if (random % 2 === 0) {
                y = y + Math.random() * 10000;
            }
            else {
                y = y - Math.random() * 10000;
            }
            series.addPoint([x * 1000, y]);
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_angular2_highcharts__ = __webpack_require__("./node_modules/angular2-highcharts/index.js");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_5__angular_material__["a" /* MatButtonModule */], __WEBPACK_IMPORTED_MODULE_5__angular_material__["b" /* MatCheckboxModule */], __WEBPACK_IMPORTED_MODULE_5__angular_material__["d" /* MatSidenavModule */], __WEBPACK_IMPORTED_MODULE_5__angular_material__["c" /* MatListModule */],
                __WEBPACK_IMPORTED_MODULE_6_angular2_highcharts__["ChartModule"].forRoot(__webpack_require__("./node_modules/highcharts/highstock.js"))
            ],
            providers: [],
